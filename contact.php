<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$subject="Wolfsurety Online Query From:".$name;
    ...
    <html> 
    <head> 
        <title>Re4lty Online Query</title> 
    </head> 
    <body> 
        <h3>Client Info</h3> 
        <table cellspacing="0" style="border: 2px dashed #FB4314; width: 100%;"> 
            ...
            <tr style="background-color: #e0e0e0;"> 
             ...
             <tr style="background-color: #e0e0e0;"> 
             <th>Required Service :</th><td>'.$service_name.'</td> 
            </tr> 
            <tr> 
                <th>Referred By:</th><td>'.$referred_by.'</td> 
            </tr> 
        </table> 
    </body>
    <p>'.$message.'</p> 
            ...
            <div class="section-masthead__inner container-fluid">
              <header class="row section-masthead__header justify-content-center">
                <div class="col-lg-8">
                  ...
                  <div class="w-100"></div>
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="mt-0 mb-0 h2">A Higher Form of Realty.</h1>
                  </div>
                  <div class="w-100"></div>
                  <div class="section__headline mt-2 mx-auto"></div>
                </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <section class="section section-form pb-medium">
                  <form class="form form-contact bg-white form-contact_paddings" action="" method="POST" >
                    <!-- header -->
                    ...
                    <div class="row form__row">
                      <div class="col form__col">
                        <label class="input-float js-input-float">
                          <input class="input-float__input" type="text" name="referred_by" required="required" data-msg="Please enter a correct e-mail"><span class="input-float__label">Reffered By</span><span class="form__error"></span>
                        </label>
                      </div>
                    </div>
                    <!-- input #2 -->
                    ...
                    <div class="row form__row">
                      <div class="col form__col">
                        <label class="input-float js-input-float">
                          <input class="input-float__input" type="text" name="phone" required="required" data-msg="Please enter a correct e-mail"><span class="input-float__label">Phone Number</span><span class="form__error"></span>
                        </label>
                      </div>
                    </div>
                    <!-- - input #2 -->
