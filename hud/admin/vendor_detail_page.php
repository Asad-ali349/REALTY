<?php
   ...
   $id=$_GET['id'];
   $data=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM vendors where id='$id'"));
                     ...
                     <div class="widget-header">
                        <div class="row">
                           ...
                           <div class="col-xl-2 col-md-2 col-sm-4 col-12">
                              <a href="edit_vendor.php?id=<?php echo $data['id'];?>" class="btn btn-danger"><i class="far fa-edit" style=" font-size: 18px;margin-right: 5px" aria-hidden="true"></i>Update</a>
                           </div>
                        </div>
                     </div>
                     <div class="widget-content">
                        <div style="text-align: left;">
                           ...
                           <div>
                               ...
                               <span><?php echo $data['street'].", ".$data['city'].", ".$data['state'].", ".$data['zip'].", ".$data['country']; ?></span>     
                           </div>
                           <div class="mt-4">
                     ...
                     <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <a href="delete_document.php?id=<?php echo $data2['id'];?>&table=vendor_docs&page=vendor_detail_page.php?id=<?php echo $id?>" onclick="return confirm('Are you sure?')"><i class="far fa-times-circle" style="color: red; font-size: 20px;" aria-hidden="true"></i></a>
