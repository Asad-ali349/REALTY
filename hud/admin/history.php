                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                        ...
                                                        <a href="add_accounting.php?case_id=<?php echo $property_data['case_id']; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="add accounting" ><li class="fa fa-calculator"></li></a>
                                                        ...
                                                        <a href="edit_property_case.php?id=<?php echo $property_data['id']; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="edit" ><li class="far fa-edit"></li></a>
                                                        <a href="delete_case.php?id=<?php echo $property_data['case_id']; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="delete"  onclick="return confirm('Are you sure?')"><li class="fa fa-trash"></li></a>
