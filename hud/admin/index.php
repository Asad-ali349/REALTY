...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($get_user)>0){
        ...
        if($data['password']==$password){
            ...
            $_SESSION['login']=true;
            $_SESSION['user_role']=$data['user_role_id'];
            header("Location: dashboard.php");

        }else{
            //wrong password
            echo "Wrong passwrord";
        }
    }else{
        //email not found
        echo "User Not Found";
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="  https://re4lty.com/img/assets/projects/logo-w.png
"/>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="terms-conditions">© 2022 All Rights Reserved by <a href="https://re4lty.com/">re4lty.com</a></p>
