                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            <li>
                                <a href="add_case.php"> Add New </a>
                            </li>
                            <li>
                                <a href="current.php"> Current Listing  </a>
                            </li>
                            <li>
                     ...
                     <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="component" data-parent="#accordionExample">
                            <li>
                                <a href="send_invite.php">Send Invite</a>
                            </li>
                            <li>
                                <a href="managers.php">View All Managers</a>
                            </li>
